...
# Mapping of PDFs
pdf_mapping = {
    'Do_the_Hard_Things_First': 'Do_the_Hard_Things_First.pdf'
...
def main():
    ...
    if selected_actual_name:
        ...
        # # file_path = selected_actual_name
        # try:
        ...
        text = read_pdf("E:/GenAI/Confluence/docs/Do_the_Hard_Things_First.pdf")
        ...
        embeddings = OpenAIEmbeddings(openai_api_key="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")
        ...
        llm = ChatOpenAI(temperature=0, max_tokens=1000, model_name="gpt-3.5-turbo",
                        openai_api_key="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")
